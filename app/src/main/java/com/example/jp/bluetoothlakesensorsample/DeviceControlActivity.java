...
public class DeviceControlActivity extends Activity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            Log.d("TEST", "Connecting to " + mDeviceAddress);
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Log.d(TAG, "Displaying Extra DATA");
    ...
    private void displayData(String data) {
        if (data != null) {
            ...
            //TODO:Perform things here (while screen is on)
            Toast.makeText(this, "Display data: " + data, Toast.LENGTH_SHORT).show();
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        // Add checking for UUID to only connect to desired GATT
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                Log.d("TEST", uuid);
                if(uuid.equals(ArduinoGattAttributes.SerialPortUUID)){
                    mSerialPortCharacteristic = gattCharacteristic;
                    System.out.println("mSerialPortCharacteristic  " + mSerialPortCharacteristic.getUuid().toString());

                    //TODO: mSerialPortCharacteristic can cause problems if no serial characteristic is found
                }
            }
